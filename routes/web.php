...
Route::post('update/product/photo/{id}','Admin\ProductController@UpdateProducPhoto');
...
Route::get('admin/add/all','Admin\PostController@index')->name('all.blogpost');
...
//Payment Step
Route::get('payment/step','CartController@PaymentPage')->name('payment.step');
