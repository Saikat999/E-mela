								...
								<div class="owl-item deals_item">
									...
									<div class="deals_content">
										<div class="deals_info_line d-flex flex-row justify-content-start">
											...
											@else
												<div class="deals_item_price_a ml-auto">TK-{{$deal->selling_price}}</div>
											@endif
										...
										<div class="deals_info_line d-flex flex-row justify-content-start">
											<div class="deals_item_name">{{$deal->product_name}}</div>
											 @if ($deal->discount_price ==NULL)
												<div class="deals_item_price ml-auto">TK-{{$deal->selling_price}}</div>
											@else
												
											@endif

											@if ($deal->discount_price != NULL)
												<div class="deals_item_price ml-auto">TK-{{$deal->discount_price}}</div>
											@else
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="product_content">
                                             ...
                                             @if ($row->discount_price == NULL)
												 <div class="product_price discount">Tk-{{$row->selling_price}}</div>
											 @else
							...
							<div class="row fill_height">
								<div class="col-lg-4 col-md-6 fill_height">
									<div class="banner_2_content">
										...
										<div class="banner_2_text"><h4>{{$mid->brand_name}}</h4>
											 <br>
                                            <h2>Tk-{{$mid->selling_price}}</h2>
										</div>
								...
								<div class="col-lg-8 col-md-6 fill_height">
									<div class="banner_2_image_container">
										<div class="banner_2_image"><img src="{{asset($mid->image_one)}}" style="height: 400px; width:350px;" alt=""></div>
									</div>
								</div>
							</div>
						</div>			
			...
			<div class="row">
                ...
                @php
					$buyget = DB::table('products')
					              ->join('brands','products.brand_id','brands.id')
								  ->select('products.*','brands.brand_name')
								  ->where('status',1)->where('buyone_getone',1)->orderBy('id','DESC')->limit(6)
								  ->get();
				@endphp
				<!-- Trends Slider -->
				<div class="col-lg-9">
        ...
        <div class="row">
           ...
           <div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<div class="form-group">
					<label for="exampleInputSize">Quantity</label>
