      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Sub Category List
              <a href="#" class="btn btn-sm btn-warning" style="float: right;" data-toggle="modal" data-target="#addnewmodal">Add New</a>
          </h6>
            ...
            <form action="{{route('store.subcategory')}}" method="POST">
             @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="subcategory_name" placeholder="Sub Category"> 
              </div>
              <div class="form-group">
