      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Blog Category List
              <a href="#" class="btn btn-sm btn-warning" style="float: right;" data-toggle="modal" data-target="#addnewmodal">Add New Category</a>
          </h6>
            ...
            <form action="{{route('store.blog.category')}}" method="POST">
             @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="category_name_ban" placeholder="Category Name Bangla"> 
              </div>
