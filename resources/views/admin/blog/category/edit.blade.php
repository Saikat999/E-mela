            ...
            <form action="{{url('update/blog/category/'.$blogcatedit->id)}}" method="POST">
             @csrf
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="category_name_en" value="{{$blogcatedit->category_name_en}}"> 
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Category Name Bangla</label>
                <input type="text" class="form-control" name="category_name_ban" value="{{$blogcatedit->category_name_ban}}"> 
              </div>
