            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="post_title_ban" placeholder="Enter Post Title in Bangla">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="summernote1" name="details_ban"></textarea>
                </div>
              </div><!-- col-4 -->
